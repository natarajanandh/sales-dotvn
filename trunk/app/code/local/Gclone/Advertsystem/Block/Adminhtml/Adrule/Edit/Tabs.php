 ...
 */
class Gclone_Advertsystem_Block_Adminhtml_Adrule_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{

  public function __construct()
  {
      parent::__construct();
      $this->setId('advertsystem_tabs');
      $this->setDestElementId('edit_form');
      $this->setTitle(Mage::helper('advertsystem')->__('Rule Information'));
  }

  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          'label'     => Mage::helper('advertsystem')->__('Rule Information'),
          'title'     => Mage::helper('advertsystem')->__('Rule Information'),
          'content'   => $this->getLayout()->createBlock('advertsystem/adminhtml_adrule_edit_tab_form')->toHtml(),
      ));
