...
class Gclone_Advertsystem_Block_Invitation extends Mage_Core_Block_Template {

    public function __construct() {
        parent::__construct();
        $this->setTemplate('advertsystem/invitation.phtml');
        Mage::app()->getFrontController()->getAction()->getLayout()->getBlock('root')->setHeaderTitle(Mage::helper('advertsystem')->__('advertsystem'));
    }
