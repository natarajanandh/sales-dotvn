 ...
 */
class Gclone_Advertsystem_Model_Mysql4_Invite extends Gclone_Advertsystem_Model_Mysql4_Abstract
{
    protected function _construct()
    {
        $this->_init('advertsystem/invite', 'invite_id');
    }

    public function getTotalInvites($signup = true, $referrerId = null)
    {
