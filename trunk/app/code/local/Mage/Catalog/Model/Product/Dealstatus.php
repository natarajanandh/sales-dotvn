 ...
 */
class Mage_Catalog_Model_Product_Dealstatus extends Mage_Core_Model_Abstract {

    const DEALSTATUS_UPCOMING  = 6;
    const DEALSTATUS_CURRENT  = 5;
    const DEALSTATUS_CLOSED     = 4;
    const DEALSTATUS_CANCELLED   = 3;
    /**
    ...
    protected function _construct() {
        $this->_init('catalog/product_dealstatus');
    }
    ...
    public function getVisibleStatusIds() {
        return array(self::DEALSTATUS_ENABLED);
    }
    ...
    static public function getOptionArray() {
        return array(
                self::DEALSTATUS_UPCOMING    => Mage::helper('catalog')->__('Upcoming'),
                self::DEALSTATUS_CURRENT    => Mage::helper('catalog')->__('Current'),
                self::DEALSTATUS_CLOSED   => Mage::helper('catalog')->__('Closed'),
                self::DEALSTATUS_CANCELLED   => Mage::helper('catalog')->__('Cancelled')
        );
    }
