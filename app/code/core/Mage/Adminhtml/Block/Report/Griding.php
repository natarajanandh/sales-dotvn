 ...
 */
class Mage_Adminhtml_Block_Report_Griding extends Mage_Adminhtml_Block_Widget_Griding
{
            ...
            foreach($orders_list as $rows) {
                ...
                foreach ($items as $itemId => $item) {
                    if($this->getFilter('deal_name') ==  $item->getProductId()) {
                        ...
                        $giftCouponCheck = $giftemail->fetchRow("select * from ".$tprefix."ordercustomer where order_id ='$order_id' and customer_name = '$customername' AND quantitynumber = $j");
