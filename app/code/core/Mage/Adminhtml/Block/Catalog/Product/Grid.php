...
class Mage_Adminhtml_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToSelect('dealstatus')
...
//        ));
        ...
        $this->addColumn('special_from_date',
                array(
                'header'=> Mage::helper('catalog')->__('Deal Starts From Date'),
                'width' => '200px',
                'type'      =>	'date',
        ...
        $this->addColumn('special_to_date',
                array(
                'header'=> Mage::helper('catalog')->__('Deal Expiry Date(Y-M-D)'),
                'width' => '200px',
                'type'      =>	'date',
        ...
        $this->addColumn('time',
                array(
                'header'=> Mage::helper('catalog')->__('Deal Expiry Time'),
                'width' => '80px',
                'index' => 'time',
        ));
