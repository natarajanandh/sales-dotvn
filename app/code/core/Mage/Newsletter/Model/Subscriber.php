...
class Mage_Newsletter_Model_Subscriber extends Mage_Core_Model_Abstract
{
    ...
    /**Author: John Thomas
     * Load subscriber data from resource model by email && City
     *
     * @param int $subscriberId
     */
    public function loadByEmailCity($subscriberEmail,$subscriberCity)
    {
        $this->addData($this->getResource()->loadByEmailCity($subscriberEmail,$subscriberCity));
        return $this;
    }
