...
class Mage_Adminhtml_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        if (isset($filter)) {
            ...
            if (isset($city)) {
                $collection->addAttributeToFilter('city', array('and' => $city));
            }
        }
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('deal_category',
                array(
                    ...
                    'index' => 'entity_id',
                    'type' => 'options',
                    'options' => Mage::getSingleton('catalog/product_dealcategory')->getOptionArray(),
                    'sortable' => false,
                    'filter' => false,
        ));
        $this->addColumn('city',
        ...
        $this->addColumn('deal_purchased',
                array(
                    ...
                    'index' => 'entity_id',
                    'type' => 'options',
                    'options' => Mage::getSingleton('catalog/product_dealpurchased')->getOptionArray(),
                    'filter' => false,
        ));
