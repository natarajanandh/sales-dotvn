 ...
 */
class Mage_Adminhtml_Block_Widget_Griding extends Mage_Adminhtml_Block_Widget
{
    /**
     * Columns array
     *
    ...
    */
    ...
    public function __construct($attributes=array())
    {
        ...
        $this->setTemplate('widget/griding.phtml');
    ...
    {
        if (is_array($column)) {
            $this->_columns[$columnId] = $this->getLayout()->createBlock('adminhtml/widget_griding_column')
                ->setData($column)
                ->setGrid($this);
        }
