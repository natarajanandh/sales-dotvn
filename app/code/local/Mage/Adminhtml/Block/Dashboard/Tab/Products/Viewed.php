...
class Mage_Adminhtml_Block_Dashboard_Tab_Products_Viewed extends Mage_Adminhtml_Block_Dashboard_Merchant
{
   ...
   // For merchant's most viewed
        $adminuser = Mage::getSingleton('admin/session')->getUser();
        $roleId = implode('', $adminuser->getRoles());
        $userId = $adminuser->getId();
        if($roleId != 1)
        {
        $collection->addFieldToFilter('merchant', array('eq' => $userId));
        }
