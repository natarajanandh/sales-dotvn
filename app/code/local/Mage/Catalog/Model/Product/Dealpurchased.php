 ...
 */
class Mage_Catalog_Model_Product_Dealpurchased extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->_init('catalog/product_dealpurchased');
    }
    ...
    {
        return array(self::DEALPURCHASED_YES);
    }
    ...
    {
        //calculating the no of deals purchased for a product.
        ...
        foreach($productCollection as $_product)
        {
            ...
            ->where('pei.product_id in (?)', $_product->getId());
            ...
            $productCount[$_product->getId()] = $count;
        }
