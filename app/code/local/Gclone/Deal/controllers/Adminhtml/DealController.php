 ...
 * =================================================================
 */
class Gclone_Deal_Adminhtml_DealController extends Mage_Adminhtml_Controller_action {
    ...
    public function editAction() {
        ...
        $model = Mage::getModel('deal/deal')->load($id);
    ...
    public function saveAction() {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $model->save();
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('deal')->__('Item was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('deal')->__('Unable to find item to save'));
        $this->_redirect('*/*/');
    }
    ...
    public function massStatusAction() {
        ...
        if (!is_array($dealIds)) {
            ...
            try {
                foreach ($dealIds as $dealId) {
                    $deal = Mage::getSingleton('deal/deal')
                                    ->load($dealId)
    ...
    public function exportCsvAction() {
        $fileName = 'deal.csv';
        $content = $this->getLayout()->createBlock('deal/adminhtml_deal_grid')
                        ->getCsv();
