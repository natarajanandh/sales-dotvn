 ...
 */
class Gclone_Advertsystem_Block_Adminhtml_Adcustomer extends Mage_Adminhtml_Block_Widget_Grid_Container
{
  public function __construct()
  {
      $this->_controller = 'adminhtml_adcustomer';
    $this->_blockGroup = 'advertsystem';  
    $this->_headerText = Mage::helper('advertsystem')->__('Customer');
    parent::__construct();
