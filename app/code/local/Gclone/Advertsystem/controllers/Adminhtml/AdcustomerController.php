 ...
 */
class Gclone_Advertsystem_Adminhtml_AdcustomerController extends Mage_Adminhtml_Controller_Action
{

	protected function _initAction() {
 
		$this->loadLayout()
			->_setActiveMenu('advertsystem/adcustomer')
	...
	public function indexAction() {
		...
		$this->_initAction()
		    ->_addContent($this->getLayout()->createBlock('advertsystem/adminhtml_adcustomer'))
		    ->renderLayout();
	}
}