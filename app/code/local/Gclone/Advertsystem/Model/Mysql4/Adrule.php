 ...
 */
class Gclone_Advertsystem_Model_Mysql4_Adrule extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {
       
        // Note that the advertsystem_id refers to the key field in your database table.
        $this->_init('advertsystem/adrule', 'rule_id');
    }
}